package es.mercadona.gesaduan.jpa.puertos.v1;
...
@Entity
@Table(name = "D_PUERTO")
public class PuertosJPA implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((codigoPuerto == null) ? 0 : codigoPuerto.hashCode());
		result = prime * result + ((fechaCreacion == null) ? 0 : fechaCreacion.hashCode());
		result = prime * result + ((fechaModificacion == null) ? 0 : fechaModificacion.hashCode());
		result = prime * result + ((nombrePuerto == null) ? 0 : nombrePuerto.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PuertosJPA other = (PuertosJPA) obj;
		if (codigoAplicacion == null) {
			if (other.codigoAplicacion != null)
				return false;
		} else if (!codigoAplicacion.equals(other.codigoAplicacion))
			return false;
		if (codigoPuerto == null) {
			if (other.codigoPuerto != null)
				return false;
		} else if (!codigoPuerto.equals(other.codigoPuerto))
			return false;
		...
		if (nombrePuerto == null) {
			if (other.nombrePuerto != null)
				return false;
		} else if (!nombrePuerto.equals(other.nombrePuerto))
			return false;
