...
@Entity
@Table(name = "S_CARGA_PEDIDO")
public class CargaPedidoJPA implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private CargaPedidoPkJPA id;
	
	@Column(name = "MCA_PEDIDO_VALIDADO")
	...
	public CargaPedidoPkJPA getId() {
		return id;
	}

	public void setId(CargaPedidoPkJPA id) {
		this.id = id;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((mcaPedidoValidado == null) ? 0 : mcaPedidoValidado.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CargaPedidoJPA other = (CargaPedidoJPA) obj;
		...
		if (mcaPedidoValidado == null) {
			if (other.mcaPedidoValidado != null)
				return false;
		} else if (!mcaPedidoValidado.equals(other.mcaPedidoValidado))
			return false;
