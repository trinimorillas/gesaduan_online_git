package es.mercadona.gesaduan.jpa.declaracionesdevalorapi.getvddocument.v2;

import java.io.Serializable;

public class VDDocumentPK implements Serializable {
	...
	public VDDocumentPK(Integer codDeclaracionValor, Integer anyo, Integer version) {
		super();
		this.codDeclaracionValor = codDeclaracionValor;
		this.anyo = anyo;
		this.version = version;
	...
	public boolean equals(Object obj) {
		...
		VDDocumentPK other = (VDDocumentPK) obj;
		if (anyo == null) {
			if (other.anyo != null) {
				return false;
			}
