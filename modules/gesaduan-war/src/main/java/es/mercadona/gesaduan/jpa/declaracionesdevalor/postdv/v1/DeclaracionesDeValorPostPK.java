...
public class DeclaracionesDeValorPostPK implements Serializable {
	...
	public DeclaracionesDeValorPostPK(Integer codDeclaracionValor, Integer anyo, Integer version) {
		super();
		this.codDeclaracionValor = codDeclaracionValor;
		this.anyo = anyo;
		this.version = version;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeclaracionesDeValorPostPK other = (DeclaracionesDeValorPostPK) obj;
		if (anyo == null) {
			if (other.anyo != null)
				return false;
	...
	public DeclaracionesDeValorPostPK() {
		super();
