...
public class ContenedorDTO extends AbstractDTO {
	...
	/**
	 * @param codigoCarga the codigoCarga to set
	 */
	...
	/**
	 * @param nombreSuministro the nombreSuministro to set
	 */
	...
	/**
	 * @return the codigoAlmacenOrigen
	 */
	...
	/**
	 * @param codigoAlmacenOrigen the codigoAlmacenOrigen to set
	 */
	...
	/**
	 * @return the codigoCentroDestino
	 */
	...
	/**
	 * @param codigoCentroDestino the codigoCentroDestino to set
	 */
	...
	/**
	 * @param marcaLpC the marcaLpC to set
	 */
