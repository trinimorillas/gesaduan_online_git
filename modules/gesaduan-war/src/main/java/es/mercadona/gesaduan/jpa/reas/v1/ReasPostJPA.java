package es.mercadona.gesaduan.jpa.reas.v1;
...
public class ReasPostJPA implements Serializable{
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReasPostJPA other = (ReasPostJPA) obj;
	...
	public String toString() {
		return "ReasPostJPA [codigoRea=" + codigoRea + ", fechaCreacion=" + fechaCreacion + ", fechaModificacion="
				+ fechaModificacion + ", codigoAplicacion=" + codigoAplicacion + ", usuarioCreacion=" + usuarioCreacion
				+ ", usuarioModificacion=" + usuarioModificacion + "]";
	}

	public ReasPostJPA(String codigoRea, Date fechaCreacion, Date fechaModificacion, String codigoAplicacion,
