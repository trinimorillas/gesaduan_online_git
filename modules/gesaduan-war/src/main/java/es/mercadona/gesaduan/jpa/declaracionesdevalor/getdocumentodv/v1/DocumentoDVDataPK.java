package es.mercadona.gesaduan.jpa.declaracionesdevalor.getdocumentodv.v1;

import java.io.Serializable;

public class DocumentoDVDataPK implements Serializable{
	...
	public DocumentoDVDataPK(Integer codDeclaracionValor, Integer anyo, Integer version) {
		super();
		this.codDeclaracionValor = codDeclaracionValor;
		this.anyo = anyo;
		this.version = version;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DocumentoDVDataPK other = (DocumentoDVDataPK) obj;
		if (anyo == null) {
			if (other.anyo != null)
				return false;
