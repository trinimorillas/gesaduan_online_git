package es.mercadona.gesaduan.dao.declaracionesdevalorapi.getvddetail.v1.impl;
...
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.DataDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.InternalOrderListDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.OutputVDDetailDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.SourceDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.TargetDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDCommonDataDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDDataDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDDeclarationIdsDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDDossierIdsDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDHeaderDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDHistoricalDTO;
import es.mercadona.gesaduan.dto.declaracionesdevalorapi.getvddetail.v1.restfull.VDLineDTO;
...
public class GetVDDetailDAOImpl extends BaseDAO<DeclaracionesDeValorJPA> implements GetVDDetailDAO {
		...
		try {
			...
			if (listado != null && !listado.isEmpty()) {
				for (Object[] tmp : listado) {
					...
					// Pedidos
					header.setInternalOrderList(getPedidos(input.getValueDeclarationNumber(), input.getValueDeclarationYear(), input.getValueDeclarationVersion(), valueDeclarationData.getDispatchCode()));
	...
	private List<InternalOrderListDTO> getPedidos(String valueDeclarationCode, String valueDeclarationYear, String valueDeclarationVersion, String expedicion) {
