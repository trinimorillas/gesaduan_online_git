package es.mercadona.gesaduan.jpa.estadoplanembarque.v1;
...
@Entity
@Table(name = "D_ESTADO_PLAN_EMBARQUE")
public class EstadoPlanEmbarqueJPA implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EstadoPlanEmbarqueJPA other = (EstadoPlanEmbarqueJPA) obj;
