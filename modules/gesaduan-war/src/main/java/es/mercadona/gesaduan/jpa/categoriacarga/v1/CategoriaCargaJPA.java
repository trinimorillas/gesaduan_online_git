package es.mercadona.gesaduan.jpa.categoriacarga.v1;
...
@Entity
@Table(name = "D_CATEGORIA_CARGA")
public class CategoriaCargaJPA implements Serializable {
	...
	@Column(name = "TXT_NOMBRE_CATEGORIA")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CategoriaCargaJPA other = (CategoriaCargaJPA) obj;
