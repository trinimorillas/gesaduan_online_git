package es.mercadona.gesaduan.jpa.estadocarga.v1;
...
@Entity
@Table(name = "D_ESTADO_CARGA")
public class EstadoCargaJPA implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EstadoCargaJPA other = (EstadoCargaJPA) obj;
